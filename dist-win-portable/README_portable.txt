...
3) Os .bat usam primeiro `.venv\Scripts\python.exe` e, se faltar, o runtime embed `python-3.10.11-embed-amd64\python.exe`. As dependencias (incluindo FBX) ja estao em `.venv\Lib\site-packages`.

Conteudo offline incluso (FBX SDK):
- Instalador original: `fbx202037_fbxpythonsdk_win.exe`
- Arquivos extraidos: `Arquivos SDK para extraidos do fbx202037_fbxpythonsdk_win.exe/2020.3.7/`
  - Wheel pronto: `fbx-2020.3.7-cp310-none-win_amd64.whl`

Se o .bat avisar que a .venv nao existe:
