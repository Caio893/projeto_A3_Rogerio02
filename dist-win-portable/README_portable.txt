...
Se a pasta `.venv` vier vazia (ex.: clonando o repo), rode `python portable_env_builder.py` dentro desta pasta com um Python 3.10 em Windows. O script cria a venv e instala as dependencias a partir da internet ou de wheels locais (`fbx_sdk/FBX Python SDK/2020.3.7/fbx-2020.3.7-cp310-none-win_amd64.whl`).
